...
function DiaryEdit(props) {
    ...
    const params_idx = params.index
    const _diary = _state[params_idx]
    console.log(_diary)
    console.log(_diary.contents)
            ...
            <Header/>
                <Grid  width='800px' margin="150px auto" is_flex flex_direction="column" align-items="center">
                    ...
                    <Grid  justify_content="center" is_flex align_items="flex-end">
                        <Input  _ref={titleRef} _defaultValue={'dddddd'} margin="0 10px" height='40px' label="Title" width = "500px" ></Input>
                    ...
                    <Image margin="30px" width="100%" _defaultValue={_diary.image_url}/>
                    <Grid margin="10px"/>
                    <Input _ref={ImageRef} _defaultValue={_diary.image_url} margin="0 10px 20px" label="Image_url" width = "600px" _onChange={changeImg_url} ></Input>
                    <Input _ref={contentsRef} _defaultValue={_diary.contents} is_textarea margin="0 10px 20px" label="Contents" height="150px"width = "600px"></Input>
                    <Input _ref={tagRef} _defaultValue={_diary.tag.join(', ')}margin="0 10px 20px" label="Hash tag" width = "600px"></Input>
